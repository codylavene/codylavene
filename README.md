...
### Things I love:
- Breaking things, only to fix them to be better than they were.
- Debugging 
- Any type of thought provoking puzzle (twisty puzzles, sudoku, crosswords, *CODE*, etc.)
- Creating anything! I make soap, candles, websites, and anything else that seems like a challenge.
